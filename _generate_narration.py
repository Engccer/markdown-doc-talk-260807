...
NARRATIONS = {
    ...
    4: "오늘 말씀드릴 것. 네 가지",
    5: "티엑스티에 없는 것 하나. 구조",
    6: "스크린 리더 사용자에게 달라지는 것",
    7: "검색 엔진도 화면을 보지 않습니다",
    8: "같은 조건, 같은 문서",
    9: "권장하는 작업 순서 세 단계. 파싱, 확정, 변환",
    10: "한글 문서만 이 순서에 들어오지 못합니다",
    11: "스킬. 반복을 없애는 장치",
    12: "문서를 몇 번 망쳐 본 뒤에 알게 된 것",
    13: "스킬이 하는 네 가지 일. 읽기, 채우기, 만들기, 대조",
    14: "학교 업무 사례 넷",
    15: "세 번째 대조에서 찾은 것",
    16: "검증의 세 층위",
    17: "기계가 채우지 못하는 것은 정확도가 아니라 책임",
    18: "마지막 구간",
